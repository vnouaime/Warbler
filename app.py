...
def add_follow(follow_id):
    ...
    # FOUND ERROR: Allows user to be able to follow themselves. Fixed code to not allow users to do this.
...
def add_like(msg_id):
    """Adds and removes like with message from user."""
...
def messages_destroy(message_id):
    ...
    # FOUND ERROR: Allowed other users to delete other users' messages. Fixed to not allow this.
...
def homepage():
    ...
    if g.user:
        following_user_ids = [user.id for user in g.user.following] + [g.user.id]
